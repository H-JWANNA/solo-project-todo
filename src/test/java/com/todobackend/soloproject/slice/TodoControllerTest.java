...
public class TodoControllerTest {
	...
	public void postTodoTest() throws Exception {
		...
		ResultActions actions = mockMvc.perform(
			post("/").accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON).content(content));
		...
		actions.andExpect(status().isCreated())
			...
			.andDo(document("post-todo", getRequestPreProcessor(), getResponsePreProcessor(),
				requestFields(fieldWithPath("title").type(JsonFieldType.STRING).description("타이틀"),
	...
	public void getTodosTest() throws Exception {
		...
		// when
		ResultActions actions = mockMvc.perform(get("/").accept(MediaType.APPLICATION_JSON));
	...
	public void getTodoTest() throws Exception {
		...
		// when
		ResultActions actions = mockMvc.perform(get("/{id}", id).accept(MediaType.APPLICATION_JSON));
		...
		actions.andExpect(status().isOk())
			...
			.andDo(document("get-todo", getRequestPreProcessor(), getResponsePreProcessor(),
	...
	public void patchTodoTest() throws Exception {
		...
		// when
		ResultActions actions = mockMvc.perform(patch("/{id}", id).accept(MediaType.APPLICATION_JSON)
		...
		actions.andExpect(status().isOk())
			...
			.andDo(document("patch-todo", getRequestPreProcessor(), getResponsePreProcessor(),
				pathParameters(parameterWithName("id").description("아이디")),
				requestFields(fieldWithPath("title").type(JsonFieldType.STRING).description("타이틀"),
					fieldWithPath("todoOrder").type(JsonFieldType.NUMBER).description("번호"),
					fieldWithPath("completed").type(JsonFieldType.BOOLEAN).description("완료 여부")),
	...
	public void deleteTodo() throws Exception {
		...
		// when
		ResultActions actions = mockMvc.perform(delete("/{id}", id));
